...
variable "deploy_ood" {
  description = "Deploy Open OnDemand server"
  type        = bool
  default     = false
}

variable "ood_shape" {
  description = "Shape for Open OnDemand server"
  type        = string
  default     = "VM.Standard2.4"
}

variable "ood_ocpus" {
  description = "Number of OCPUs for flexible OOD shape"
  type        = number
  default     = 2
}

variable "ood_memory" {
  description = "Amount of memory in GB for flexible OOD shape"
  type        = number
  default     = 16
}

variable "ood_boot_volume_size" {
  description = "Size of the boot volume in GB for OOD server"
  type        = number
  default     = 50
}

variable "ood_username" {
  description = "Default username for OOD node"
  type        = string
  default     = "opc"
}

variable "use_marketplace_image_ood" {
  description = "Use marketplace image for OOD node"
  type        = bool
  default     = true
}

variable "marketplace_listing_ood" {
  description = "Marketplace listing for OOD node"
  type        = string
  default     = "HPC_OL8"
}

variable "custom_ood_image" {
  description = "Custom image OCID for OOD node"
  type        = string
  default     = "image.ocid"
}

variable "ood_ad" {
  description = "Availability Domain for OOD node"
  type        = string
  default     = ""
}

variable "domain_name" {
  description = "The name of the IDCS domain."
  type        = string
}
...
variable "redirect_uris" {
  description = "The list of redirect URIs for the Web Application."
  type        = list(string)
}
...
variable "ood_admin_username" {
  description = "Initial username for the OOD portal. Will be linked to the user email"
  type        = string
  default     = "admin"
}

variable "ood_user_email" {
  description = "Default email for OOD node"
  type        = string
